...
$sql="UPDATE SPESA SET 
	 importo = '$myimporto', 
	 id_tipo_spesa = '$mytipospesa', 
	 note = '$mynote', 
	 data = '$mydata'
	 WHERE ID = '$idUltimoInsert' ";


$result=mysql_query($sql);
if ($result) {
?>
<script>alert("Modifica riuscita");</script>
<?php
		//header("location: inserisci_spesa.php");
	} else {
?>
<script>alert("Modifica non riuscita");</script>
<?php
	}
}
?>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
				<ul class="nav navbar-nav">
					...
					<li class="active"><a href="modifica_ultima_spesa.php">Modifica ultima spesa</a></li> 
	...
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
				...
				<p>
					<?php
						echo $importoRecuperato;
                        echo $dataRecuperata;
                        echo $noteRecuperate;
                        echo $tipoSpesaRecuperata;
					?>
				</p>
				-->
				<form action="" method="post" name="aggiungi_spesa">
						<h4>Modifica ultima spesa</h4>
						<div class="form-group">
							<label for="importo" class="control-label">Importo</label>
							<input type="number" class="form-control" step="any" id="importo" required="true" name="importo" value="<?php echo $importoRecuperato ?>">
						</div>
						<div class="form-group">
							<label for="data" class="control-label">Data</label>
							<input type="date" class="form-control" id="data" required="true" name="data" value="<?php echo $dataRecuperata ?>">
						</div>
						<div class="form-group">
							<label for="note" class="control-label">Note</label>
							<input type="text" class="form-control" id="note" name="note" maxlength="150" size="150" value="<?php echo $noteRecuperate ?>">
						</div>
						<div class="form-group">
							...
							?>
								<option value="<?php echo $row['id']?>" <?php if($row['id'] == $tipoSpesaRecuperata) {echo "selected";} ?> >
