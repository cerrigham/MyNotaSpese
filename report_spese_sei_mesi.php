...
$meseCorrente = date('m');
$annoCorrente = date('Y');
$mesePrecedente = $meseCorrente - 5;
$annoPrecedente = $annoCorrente; 
if($meseCorrente < 6) {
	$mesePrecedente = $mesePrecendete + 12;
	$annoPrecedente = $annoPrecedente - 1;
}
$dataDa=date('Y-m-d', strtotime(date('Y-m')." -6 month"));
$dataA=date('Y-m-31');
?>
<html>
<head>
